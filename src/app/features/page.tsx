...
const featureFaqs = [
  ...
  { question: "Can clients pay using UPI?", answer: "Yes, when your workspace has a UPI ID configured. The private invoice payment page displays a UPI QR code for the outstanding amount, which clients can scan in a compatible UPI app." },
